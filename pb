...
sudo apt-get -y install debconf-utils unzip gosu libgl1 libvulkan1 tzdata nano man-db systemd net-tools iproute2 dialog apt-transport-https ca-certificates gnupg software-properties-common
